...
<div class="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6 max-w-lg mx-auto">
    <form action="<?php echo URLROOT; ?>/usercontroller/create" method="POST">
        <!-- First Name & Last Name -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                <label class="block text-gray-700 text-sm font-bold mb-2" for="first_name">ชื่อจริง</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="first_name" name="first_name" type="text" value="<?php echo $data['first_name'] ?? ''; ?>">
            </div>
            <div>
                <label class="block text-gray-700 text-sm font-bold mb-2" for="last_name">นามสกุล</label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" id="last_name" name="last_name" type="text" value="<?php echo $data['last_name'] ?? ''; ?>">
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border <?php echo (!empty($data['username_err'])) ? 'border-red-500' : ''; ?> rounded w-full py-2 px-3 text-gray-700" id="username" name="username" type="text" value="<?php echo $data['username'] ?? ''; ?>">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border <?php echo (!empty($data['email_err'])) ? 'border-red-500' : ''; ?> rounded w-full py-2 px-3 text-gray-700" id="email" name="email" type="email" value="<?php echo $data['email'] ?? ''; ?>">
        ...
        <div class="mb-6">
            ...
            <input class="shadow appearance-none border <?php echo (!empty($data['confirm_password_err'])) ? 'border-red-500' : ''; ?> rounded w-full py-2 px-3 text-gray-700" id="confirm_password" name="confirm_password" type="password">
