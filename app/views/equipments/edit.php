...
<div class="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-6">
    <form action="<?php echo URLROOT; ?>/equipmentcontroller/edit/<?php echo $data['id']; ?>" method="POST">
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="name">
                ชื่ออุปกรณ์
            </label>
            <input class="shadow appearance-none border <?php echo (!empty($data['name_err'])) ? 'border-red-500' : ''; ?> rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" value="<?php echo $data['equipment']->name; ?>">
        ...
        <div class="mb-6">
            ...
            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" name="description" rows="3"><?php echo $data['equipment']->description; ?></textarea>
        </div>
